...
assert.match(byName("BBK Glam — Makeup per person").name, /Makeup per person/);
assert.match(P.formatPrice(byName("BBK Glam — Makeup per person")), /\$250–\$300/);
assert.equal(P.calculate(byName("BBK Full Bridal Glam — Hair \+ Makeup for Bride \+ 4"), [], { enabled:false }).total < P.calculate(byName("BBK Glam — Makeup per person"), [], { enabled:false }).total * 5, true);
