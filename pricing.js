(function (root) {
  ...
  const services = [
    ...
    service("basic-glam", "BBK Basic Glam", "Makeup", "fixed", 75, 75, "A polished basic-glam makeup application."),
    service("full-glam", "BBK Full Glam", "Makeup", "fixed", 150, 150, "One full-glam makeup application for one person, customized for the requested finish."),
    service("bbk-glam-party", "BBK Glam", "Makeup", "range", 250, 300, "Makeup services for small parties and special occasions.", { notice: "Up to 2 people — $250 total. Up to 3 people — $300 total. Parties of 4 or more require a custom quote based on party size, timing, location, and service requirements.", questionnaire: "makeupParty", requiredUploads: ["inspiration"], duration: 180 }),
    service("wedding-glam", "BBK Full Bridal Glam — Hair + Makeup for Bride + 3", "Makeup", "starting", 1195, null, "Wedding-day hair and makeup for the bride plus up to three additional people, for a maximum of four people total. Pricing starts at $1,195.", { notice: "Parties larger than 4 require a custom quote and may require an additional beauty professional. Final pricing is reviewed for requested styles, complexity, location, travel, ready-by time, timeline, and staffing needs.", questionnaire: "wedding", requiredUploads: ["inspiration"], statusLabel: "Pending Kia’s review" })
  ];
